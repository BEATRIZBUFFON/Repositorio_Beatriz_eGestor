...
df = pd.read_csv('Fattura_Fevereiro_2023.csv')
...
soma = df_trials['valor'].sum().round()
...
app.layout = dbc.Container([
    dbc.Col([
        html.Div([
            ...
            html.H5(""),
            html.H6("Faturamento total dos setores:"),
            dbc.Row([
                dbc.Col([
                    dbc.Card(
                        dbc.CardBody(
                            [html.P("FARMER", className="card-title1"),
                            html.H5(f"{df_farmer['valor'].sum().round()}", className="card-text1")
                            ]),style={"width": "18rem"},
                    ),
                    ], md=4),
                dbc.Col([
                    dbc.Card(
                        dbc.CardBody(
                            [html.P("NFEMAIS", className="card-title2"),
                            html.H5(f"{df_nfemais['valor'].sum().round()}", className="card-text2")
                            ]),style={"width": "18rem"},
                    ),
                    ], md=4),
                dbc.Col([
                    dbc.Card(
                        dbc.CardBody(
                            [html.P("OUTBAND", className="card-title3"),
                            html.H5(f"{df_outband['valor'].sum().round()}", className="card-text3")
                            ]),style={"width": "18rem"},
                    ),
                    ], md=4),
            html.H5(""),
                dbc.Col([
                    dbc.Card(
                        dbc.CardBody(
                            [html.P("CS", className="card-title4"),
                            html.H5(f"{df_cs['valor'].sum().round()}", className="card-text4")
                            ]),style={"width": "18rem"},
                    ),
                    ], md=4),
                dbc.Col([
                    dbc.Card(
                        dbc.CardBody(
                            [html.P("TRIALS", className="card-title5"),
                            html.H5(f"{df_trials['valor'].sum().round()}", className="card-text5")
                            ]),style={"width": "18rem"},
                    ),
                    ], md=4),
                dbc.Col([
                    dbc.Card(
                        dbc.CardBody(
                            [html.P("INBAND", className="card-title6"),
                            html.H5(f"{df_inband['valor'].sum().round()}", className="card-text6")
                            ]),style={"width": "18rem"},
                    ),
                    ], md=4),
                ]),
...
app.run_server(port='8070', host='192.168.40.230')
